...
project_id: "provisioning--security-compliance--grype"
maturity: null
openapi_status: todo
---
...
![Grype](/logos/f72e080dff1835a47f57bbd430af2f7c4b25627a8cddae7a71fed68182968a6a.svg)
...
- [Strona główna](https://github.com/anchore/grype)
...
> **TODO:** Pełna specyfikacja w submodule `openapi/provisioning--security-compliance--grype` — aktualizacja przez CI/CD.

| | |
|---|---|
| Status | `todo` |
| Docelowy URL | [/openapi/provisioning--security-compliance--grype/](/openapi/provisioning--security-compliance--grype/) |
| Submodule | `openapi/provisioning--security-compliance--grype` |
| Szukaj w repo | — |
