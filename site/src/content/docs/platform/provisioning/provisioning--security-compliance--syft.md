---
title: Syft
description: "Syft is a CLI tool and library for generating a Software Bill of Materials from container images and filesystems"
domain: "platform"
category: "Provisioning"
subcategory: "Security & Compliance"
project_id: "provisioning--security-compliance--syft"
maturity: null
openapi_status: todo
---
...
![Syft](/logos/2ccf75691acd20e7f5b2e2b4d72e08298222329112e0e3cdccbb2cb3da8cf160.svg)
...
- Syft: Syft is a CLI tool and library for generating a Software Bill of Materials from container images and filesystems
...
- [Strona główna](https://github.com/anchore/syft)
- [Blog](https://anchore.com/blog/)
...
> **TODO:** Pełna specyfikacja w submodule `openapi/provisioning--security-compliance--syft` — aktualizacja przez CI/CD.

| | |
|---|---|
| Status | `todo` |
| Docelowy URL | [/openapi/provisioning--security-compliance--syft/](/openapi/provisioning--security-compliance--syft/) |
| Submodule | `openapi/provisioning--security-compliance--syft` |
| Szukaj w repo | — |
