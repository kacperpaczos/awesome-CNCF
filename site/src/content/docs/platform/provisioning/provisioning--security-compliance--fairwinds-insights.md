...
project_id: "provisioning--security-compliance--fairwinds-insights"
maturity: null
openapi_status: todo
---
...
![Fairwinds Insights](/logos/f92ca6681c1aee3b4210c5f6d43ca8d90f5d0a2c646338a7040b9c0bee1f3510.svg)
...
- [Strona główna](https://fairwinds.com/insights)
...
> **TODO:** Pełna specyfikacja w submodule `openapi/provisioning--security-compliance--fairwinds-insights` — aktualizacja przez CI/CD.

| | |
|---|---|
| Status | `todo` |
| Docelowy URL | [/openapi/provisioning--security-compliance--fairwinds-insights/](/openapi/provisioning--security-compliance--fairwinds-insights/) |
| Submodule | `openapi/provisioning--security-compliance--fairwinds-insights` |
| Szukaj w repo | — |
