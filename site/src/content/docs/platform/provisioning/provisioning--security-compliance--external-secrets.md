...
project_id: "provisioning--security-compliance--external-secrets"
maturity: "sandbox"
openapi_status: todo
sidebar:
  badge:
...
![external-secrets](/logos/07686e3ac9335c6071c003bba42cc984b1bbef6feaa1b6ed02626937968d6e3b.svg)
...
- [Strona główna](https://external-secrets.io/)
- [DevStats CNCF](https://externalsecretsoperator.devstats.cncf.io/)
- [Artwork](https://github.com/cncf/artwork/tree/master/projects/external-secrets-operator)
...
> **TODO:** Pełna specyfikacja w submodule `openapi/provisioning--security-compliance--external-secrets` — aktualizacja przez CI/CD.

| | |
|---|---|
| Status | `todo` |
| Docelowy URL | [/openapi/provisioning--security-compliance--external-secrets/](/openapi/provisioning--security-compliance--external-secrets/) |
| Submodule | `openapi/provisioning--security-compliance--external-secrets` |
| Szukaj w repo | [źródło](https://github.com/external-secrets/external-secrets/tree/HEAD) |
...
| Incubating | — |
| Archived | — |
| CLOMonitor | external-secrets |

## GitHub

- Gwiazdki GitHub: **6,669**
- Licencja: **Apache License 2.0**
- Tematy: `external-secrets`, `hacktoberfest`, `kubernetes`, `kubernetes-secrets`, `secrets-manager`
