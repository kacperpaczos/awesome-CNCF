...
project_id: "provisioning--security-compliance--prisma-cloud"
maturity: null
openapi_status: todo
---
...
![Prisma Cloud](/logos/443a6585ca769e0a3428b45778f8e4188d6d102877058796fed3bbb1a3ec5765.svg)
...
- [Strona główna](https://www.paloaltonetworks.com/prisma/cloud)
...
> **TODO:** Pełna specyfikacja w submodule `openapi/provisioning--security-compliance--prisma-cloud` — aktualizacja przez CI/CD.

| | |
|---|---|
| Status | `todo` |
| Docelowy URL | [/openapi/provisioning--security-compliance--prisma-cloud/](/openapi/provisioning--security-compliance--prisma-cloud/) |
| Submodule | `openapi/provisioning--security-compliance--prisma-cloud` |
| Szukaj w repo | — |
